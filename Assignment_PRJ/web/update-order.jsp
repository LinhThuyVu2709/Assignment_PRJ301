                            ...
                            <div class="col-lg-8 col-md-6">
                                <div class="checkout__input">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <p>Order ID</p>
                                            <input type="text" id="orderId" name="orderId" value="${order.id}" readonly="readonly">
                                        </div>
                                        <div class="col-lg-8">
                                            <p>By Account ID</p>
                                            <input type="text" id="account_id" name="account_id" value="${order.account_id}" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="checkout__input">
                                    <p>Created time</p>
                                    <input type="text" id="created_date" name="created_date" value="${order.created_date}">
                                </div>
                                <div class="checkout__input">
                                    <p>Shipping_id</p>
                                    <input type="text" id="shipping_id" name="shipping_id" value="${order.shipping_id}" readonly="readonly">
                                </div>
