<%-- 
    Document   : baing-tools
    Created on : Mar 7, 2022, 2:20:27 AM
    Author     : LinhVT
--%>
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="breadcrumb__text">
                            ...
                            <div class="breadcrumb__option">
                                <a href="Home">Home</a>
                                <span>Bakewares - Baking Tools</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <div class="filter__found">
                                        <h6><span>${listBakingTool.size()}</span> Products found</h6>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <c:forEach items="${listBakingTool}" var="bakingtool">
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        <div class="product__item__pic set-bg" data-setbg="${bakingtool.imageURL}">
                                            <ul class="product__item__pic__hover">
                                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                            </ul>
                                        </div>
                                        <div class="product__item__text">
                                            <h6><a href="#">${bakingtool.name}</a></h6>
                                            <h5>$${bakingtool.price}</h5>
                                        </div>
                                    </div>
                                </div>
                            </c:forEach>
                        ...
                        <div class="product__pagination">
                            <c:choose>
                                <c:when test="${page>1}">
                                    <a href="BakingTool?page=${page-1}"><i class="fa fa-long-arrow-left"></i></a>
                                </c:when>
                                <c:otherwise>
                            ...
                            <a class="${i==page?"active" : ""}" href="BakingTool?page=${i}">${i}</a>
                            </c:forEach>
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="BakingTool?page=${page+1}"><i class="fa fa-long-arrow-right"></i></a>
                                </c:otherwise>
                            </c:choose>
