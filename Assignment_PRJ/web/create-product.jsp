                    ...
                    <form action="CreateProduct" method="post">
                        <div class="row">
                            <div class="col-lg-8 col-md-6">
                                ...
                                <div class="checkout__input">
                                    <p>ImageURL</p>
                                    <input type="text" id="imageURL" name="imageURL" class="checkout__input__add">
                                </div>
                                <div class="row">
                                    <p class="checkout__input">Sub Category</p>
                                    <div class="col-lg-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sub_id" id="sub_id" value="1">
                                            <label class="form-check-label" for="sub_id">Silicone Bakeware</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sub_id" id="sub_id" value="2">
                                            <label class="form-check-label" for="sub_id">Nonstick & Stin Bakeware</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sub_id" id="sub_id" value="3">
                                            <label class="form-check-label" for="sub_id">Paper Bakeware</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sub_id" id="sub_id" value="4">
                                            <label class="form-check-label" for="sub_id">Baking Tools</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sub_id" id="sub_id" value="5">
                                            <label class="form-check-label" for="sub_id">Colour Dust & Flavours</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sub_id" id="sub_id" value="6">
                                            <label class="form-check-label" for="sub_id">Baking Ingredients</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sub_id" id="sub_id" value="7">
                                            <label class="form-check-label" for="sub_id">Chocolate Ingredients</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sub_id" id="sub_id" value="8">
