<%-- 
    Document   : nonstick-stinbakeware
    Created on : Mar 7, 2022, 2:17:33 AM
    Author     : LinhVT
--%>
...
<html lang="zxx">
    ...
    <head>
        ...
        <title>Nonstick & Stin Bakeware</title>
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="breadcrumb__text">
                            ...
                            <div class="breadcrumb__option">
                                <a href="Home">Home</a>
                                <span>Bakewares - Nonstick & Stin Bakeware</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <div class="filter__found">
                                        <h6><span>${listNonstickBakeware.size()}</span> Products found</h6>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <c:forEach items="${listNonstickBakeware}" var="nonstick">
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        <div class="product__item__pic set-bg" data-setbg="${nonstick.imageURL}">
                                            <ul class="product__item__pic__hover">
                                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                            </ul>
                                        </div>
                                        <div class="product__item__text">
                                            <h6><a href="#">${nonstick.name}</a></h6>
                                            <h5>$${nonstick.price}</h5>
                                        </div>
                                    </div>
                                </div>
                            </c:forEach>      
