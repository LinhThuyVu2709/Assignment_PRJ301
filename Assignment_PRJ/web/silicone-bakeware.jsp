<%-- 
    Document   : silicon-bakeware
    Created on : Mar 7, 2022, 2:15:18 AM
    Author     : LinhVT
--%>
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="breadcrumb__text">
                            ...
                            <div class="breadcrumb__option">
                                <a href="Home">Home</a>
                                <span>Bakewares - Silicon Bakeware</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <div class="filter__found">
                                        <h6><span>${listSiliconeBakeware.size()}</span> Products found</h6>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <c:forEach items="${listSiliconeBakeware}" var="silicone">
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        <div class="product__item__pic set-bg" data-setbg="${silicone.imageURL}">
                                            <ul class="product__item__pic__hover">
                                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                            </ul>
                                        </div>
                                        <div class="product__item__text">
                                            <h6><a href="#">${silicone.name}</a></h6>
                                            <h5>${silicone.price}</h5>
                                        </div>
                                    </div>
                                </div>
                            </c:forEach>
                        ...
                        <div class="product__pagination">
                            <c:choose>
                                <c:when test="${page>1}">
                                    <a href="SiliconBakeware?page=${page-1}"><i class="fa fa-long-arrow-left"></i></a>
                                </c:when>
                                <c:otherwise>
                            ...
                            <a class="${i==page?"active" : ""}" href="SiliconBakeware?page=${i}">${i}</a>
                            </c:forEach>
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="SiliconBakeware?page=${page+1}"><i class="fa fa-long-arrow-right"></i></a>
                                </c:otherwise>
                            </c:choose>
