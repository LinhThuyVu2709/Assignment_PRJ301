<%-- 
    Document   : paper-bakeware
    Created on : Mar 7, 2022, 2:17:05 AM
    Author     : LinhVT
--%>
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="breadcrumb__text">
                            ...
                            <div class="breadcrumb__option">
                                <a href="Home">Home</a>
                                <span>Bakewares - Paper Bakeware</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <div class="filter__found">
                                        <h6><span>${listPaperBakeware.size()}</span> Products found</h6>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <c:forEach items="${listPaperBakeware}" var="paper">
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        <div class="product__item__pic set-bg" data-setbg="${paper.imageURL}">
                                            <ul class="product__item__pic__hover">
                                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="product__pagination">
                            <c:choose>
                                <c:when test="${page>1}">
                                    <a href="PaperBakeware?page=${page-1}"><i class="fa fa-long-arrow-left"></i></a>
                                </c:when>
                                <c:otherwise>
                            ...
                            <a class="${i==page?"active" : ""}" href="PaperBakeware?page=${i}">${i}</a>
                            </c:forEach>
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="PaperBakeware?page=${page+1}"><i class="fa fa-long-arrow-right"></i></a>
                                </c:otherwise>
                            </c:choose>
