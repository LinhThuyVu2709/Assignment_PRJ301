<%-- 
    Document   : baking-ingredients
    Created on : Mar 7, 2022, 2:20:06 AM
    Author     : LinhVT
--%>
...
<html lang="zxx">
    ...
    <head>
        ...
        <title>Baking Ingredients</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-7">
                        ...
                        <div class="product__pagination">
                            <c:choose>
                                <c:when test="${page>1}">
                                    <a href="BakingIngredient?page=${page-1}"><i class="fa fa-long-arrow-left"></i></a>
                                </c:when>
                                <c:otherwise>
                            ...
                            <a class="${i==page?"active" : ""}" href="BakingIngredient?page=${i}">${i}</a>
                            </c:forEach>
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="BakingIngredient?page=${page+1}"><i class="fa fa-long-arrow-right"></i></a>
                                </c:otherwise>
                            </c:choose>
